...
const UpdateRecipeForm = (props) => {
    ...
    const updateRecipeSubmit = () => {
        if (!checkErrors()) {
            ...
            if (tags)
                updatedRecipe.tags = tags.split(",");
            (0, recipe_actions_1.updateRecipe)(recipe._id, updatedRecipe);
