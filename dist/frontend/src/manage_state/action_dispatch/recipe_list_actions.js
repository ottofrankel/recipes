...
exports.deleteRecipe = exports.postRecipe = exports.fetchFavs = exports.fetchRecipes = void 0;
...
const deleteRecipe = (id) => {
    axios_1.default.delete(`${constants_1.BASE_API_URL}/recipes/${id}`)
        .then(res => {
        store_1.store.dispatch((0, recipeListSlice_1.removeRecipe)(res.data));
    });
};
