...
const RecipeSearch = () => {
    ...
    const [favFilter, setFavFilter] = (0, react_1.useState)(currentFilters.fav ? currentFilters.fav === true : false);
    const [tagFilter, setTagFilter] = (0, react_1.useState)((_d = currentFilters.tags) !== null && _d !== void 0 ? _d : '');
    const [sort, setSort] = (0, react_1.useState)((_e = currentFilters.sort) !== null && _e !== void 0 ? _e : '');
