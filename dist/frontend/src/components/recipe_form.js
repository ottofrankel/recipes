...
const RecipeForm = ({ recipe, formType }) => {
    ...
    const handleSubmit = () => {
        ...
        if (!errors.error) {
            ...
            console.log(tags);
            console.log(tags === null || tags === void 0 ? void 0 : tags.split(" "));
            if (tags) {
